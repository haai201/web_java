<%-- 
    Document   : donban
    Created on : May 29, 2021, 4:09:07 PM
    Author     : nhadu
--%>
            ...
            <% } if (lv.equals(lvl1) || lv.equals(lvl2)) { %>
             ...
             <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu bg-dark navbar-dark " >
                    <a class="dropdown-item" style="color: white;" href="http://localhost:8080/quanlynhathuoc/main/donnhap.fsp">
                        Đơn nhập
                    </a>    
...
<!--                    <div class="dropdown-divider"></div>-->
        ...
        <table class="table table-sm">
            ...
            DecimalFormat formatter = new DecimalFormat("###,###,###");
              ...
              <tr>
                <th scope="row"><%=stt%></th>
                <td><%=rs.getString("NgayBan")%></td>
                <td><%=rs.getString("MaHDB")%></td>
